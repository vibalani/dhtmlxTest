...
export interface IEventHandlersMap {
    ...
    [GridEvents.beforeColumnHide]: (col: ICol) => boolean;
    [GridEvents.afterColumnHide]: (col: ICol) => void;
    [GridEvents.beforeColumnShow]: (col: ICol) => boolean;
    [GridEvents.afterColumnShow]: (col: ICol) => void;
    [GridEvents.beforeRowHide]: (row: IRow) => boolean;
    [GridEvents.afterRowHide]: (row: IRow) => void;
    [GridEvents.beforeRowShow]: (row: IRow) => boolean;
...
export interface IGridSelectionEventsHandlersMap {
    ...
    [GridSelectionEvents.afterEnable]: () => any;
    [GridSelectionEvents.afterDisable]: () => any;
    [GridSelectionEvents.beforeEnable]: () => void | boolean;
    [GridSelectionEvents.beforeDisable]: () => void | boolean;
}
export {};
